...
// https://github.com/denizsucu/JavaCamp/blob/master/GameStoreProject/src/Main.java
// 4. gun odev 3

import abstracts.CustomerCheckService;
import abstracts.GameSaleService;
import adapters.IdentityServiceAdapter;
import be.intecbrussel.adapters.IdentityServiceAdapter;
...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        CustomerCheckService customerCheckService = new IdentityServiceAdapter();
